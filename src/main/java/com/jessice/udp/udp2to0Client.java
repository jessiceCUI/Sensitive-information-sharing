...
public class udp2to0Client extends Thread{
	public static void main(String[] args) throws IOException {
		System.out.println("发送端7002启动....");
	//1.建立UDP的Socket服务；使用DatagramSocket
		DatagramSocket ds=new DatagramSocket(7002); //指定发送端端口


		//2.创建数据包；使用DatagramPacket，确定目的地址
		byte [] buf=new String("7002向7000发送udp").getBytes();
		DatagramPacket dp =
	...
	/*public static void send1to0() throws IOException
	{
